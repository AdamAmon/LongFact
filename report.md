...
1. Cao, M., Dong, Y., Wu, J., & Cheung, J. C. K. (2020). Factual Error Correction for Abstractive Summarization Models. In *Proceedings of the 2020 Conference on Empirical Methods in Natural Language Processing (EMNLP)*, pp. 6251–6258. [https://aclanthology.org/2020.emnlp-main.506/](https://aclanthology.org/2020.emnlp-main.506/)
2. Liu, Y., Fabbri, A. R., Liu, P., Zhao, Y., Nan, L., Han, R., ... & Radev, D. R. (2023). On Improving Summarization Factual Consistency from Natural Language Feedback. In *Proceedings of the 61st Annual Meeting of the Association for Computational Linguistics (ACL)*, pp. 15128–15145. [https://aclanthology.org/2023.acl-long.844/](https://aclanthology.org/2023.acl-long.844/)
3. Wang, B., Zhang, P., Zhu, J., Wang, X., Zhou, J., & Li, S. (2024). Identifying Factual Inconsistencies in Summaries: Grounding LLM Inference via Task Taxonomy. In *Findings of the Association for Computational Linguistics: EMNLP 2024*, pp. 14134–14149. [https://aclanthology.org/2024.findings-emnlp.857/](https://aclanthology.org/2024.findings-emnlp.857/)
4. Beltagy, I., Peters, M. E., & Cohan, A. (2021). Efficient Attentions for Long Document Summarization. In *Proceedings of the 2021 Conference of the North American Chapter of the Association for Computational Linguistics: Human Language Technologies (NAACL-HLT)*, pp. 1416–1426. [https://aclanthology.org/2021.naacl-main.112/](https://aclanthology.org/2021.naacl-main.112/)
5. Huang, L., Wu, L., & Wang, L. (2022). GovReport: A Dataset for Government Reports Summarization. `ccdv/govreport-summarization`, Hugging Face Datasets.
6. Lin, C.-Y. (2004). ROUGE: A Package for Automatic Evaluation of Summaries. In *Text Summarization Branches Out*, pp. 74–81. ACL.
